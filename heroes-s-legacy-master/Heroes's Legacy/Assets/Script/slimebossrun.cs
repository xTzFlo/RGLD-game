...
public class slimebossrun : StateMachineBehaviour
{
    GameObject[] mages;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            if (Vector2.Distance(obj.transform.position, rgdb.position) <= 8)
            {
                Near = obj.transform;
            }
        }
        ...
        if (Near != null)
        {
            ...
            {
                rgdb.transform.localScale = new Vector3(-0.41f, 0.43f, 1f);
                isFlipped = false;
            }

...
public class roidemonidle : StateMachineBehaviour
{
    GameObject[] mages;
...
Rigidbody2D rgdb;
    ...
    float distanceDetection = 10f;
    public float distanceNear;
    public bool isFlipped = false;
    public bool letRest = false;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (Near != null && !letRest)
        {
            ...
            {
                rgdb.transform.localScale = new Vector3(-0.08f, 0.08f, 1f);
                Debug.Log("TRANSFORM LOCALSCALE PUTAIN");
                isFlipped = true;
            }
